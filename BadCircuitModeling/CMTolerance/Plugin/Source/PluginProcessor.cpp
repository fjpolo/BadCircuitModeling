...
{
    freqParam = (float*)(vts.getRawParameterValue ("cutoff_Hz"));
    qParam = (float*)vts.getRawParameterValue ("filtq_");
    tolParam = (float*)vts.getRawParameterValue ("tol");
}
...
AudioProcessorValueTreeState::ParameterLayout CmtoleranceAudioProcessor::createParameterLayout()
{
    ...
    params.push_back (std::make_unique<AudioParameterFloat> ("cutoff_Hz", "fc", freqRange, 1000.0f));
